...
dataItem_t bmsItems[] = {
    ...
    {0x8000, "Battery Voltage", 0, 16, PACK_UNSIGNED_MILLI},
    {0x8000, "Battery Current", 16, 16, PACK_SIGNED_CENTI},
    {0x8000, "Battery Target Voltage", 32, 8, PACK_UNSIGNED_MILLI},
    {0x8000, "Battery Target Current", 40, 8, PACK_SIGNED_UNIT},
    {0x8000, "Cell Voltage Range", 48, 8, PACK_UNSIGNED_MILLI},
    {0x8000, "Battery Temperature", 56, 8, PACK_SIGNED_UNIT},
};
